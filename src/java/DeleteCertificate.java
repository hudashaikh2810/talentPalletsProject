 ...
 * @author HUDA
 */
public class DeleteCertificate extends HttpServlet {
Connection con=null;
Statement smt=null;
ResultSet rs=null;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteCertificate</title>");            
            out.println("</head>");
            out.println("<body>");
      ...
      String email=request.getParameter("email");
       try {
            ...
            String query="delete from certificate where name='"+name+"' and email='"+email+"'";
